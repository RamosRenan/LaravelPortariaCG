...
@section('content_header')
    <h1><i class="fa fa-calendar-plus"></i> @lang('global.dentist.schedules.title') <small>@lang('global.app_create')</small></h1>
@stop

@section('content')
    {!! Form::open(['method' => 'POST', 'route' => ['dentist.schedules.store']]) !!}
