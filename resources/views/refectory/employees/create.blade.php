...
@section('content')
    {{ Form::open(['method' => 'POST', 'route' => ['refectory.employees.store']]) }}
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6 form-group">
                    ...
                    {{ Form::select('units[]', $units, old('units'), ['class' => 'form-control select2', 'multiple' => 'multiple']) }}
                    @if($errors->has('units'))
                ...
                <div class="col-md-6 form-group">
                    ...
                    {{ Form::select('specialties[]', $specialties, old('specialties'), ['class' => 'form-control select2', 'multiple' => 'multiple']) }}
