...
@section('js') 
    <script>
        ...
        var route = '{{ route('admin.permissions.mass_destroy') }}';
    </script>
@stop
...
<div class="card card-default">
        <div class="card-header">
            <div class="row">
                <div class="col-md-6">
                    @can('@@ superadmin @@')
                    <a href="{{ route('admin.permissions.create') }}" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> @lang('global.app_create')</a>
                    @endcan
                </div>
                <div class="col-md-6">
                    <div class="float-sm-right">
                        {{ Form::open(['method' => 'GET', 'route' => ['admin.permissions.index']]) }}
            ...
            <table class="table table-head-fixed table-hover">
                <thead>
                    <tr>
                        ...
                        <th>@lang('permissions.fields.module')</th>
                        <th>&nbsp;</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr data-entry-id="{{ $item->id }}">
                        ...
                        <td class="text-right align-middle">
                            {{ Form::open([
                                ...
                                'method' => 'DELETE',
                                'route' => ['admin.permissions.destroy', $item->id]
                            ]) }}
                            {{ Form::close() }}
                            <div class="btn-group">
                                <a href="{{ route('admin.permissions.edit',[$item->id]) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> @lang('global.app_edit')</a>
