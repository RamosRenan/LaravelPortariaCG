...
@section('js') 
    <script>
        ...
        var route = '{{ route('admin.dashboard.mass_destroy') }}';
    </script>
@stop
...
@section('content')
    <div class="card card-default">
        <div class="card-header">
            <div class="row">
                <div class="col-md-6">
                    <a href="{{ route('admin.dashboard.create') }}" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> @lang('global.app_create')</a>
                </div>
                <div class="col-md-6">
                    <div class="float-sm-right">
                        {{ Form::open(['method' => 'GET', 'route' => ['admin.dashboard.index']]) }}
            ...
            <table class="table table-head-fixed table-hover">
                <thead>
                    <tr>
                        ...
                        <th>@lang('dashboard.fields.title')</th>
                        <th>@lang('dashboard.fields.name')</th>
                        <th>@lang('dashboard.fields.role')</th>
                        <th>@lang('dashboard.fields.grid')</th>
                        <th>&nbsp;</th>
                    </tr>
                </thead>
                <tbody>
                ...
                <tr data-entry-id="{{ $item->id }}">
                    ...
                    <td class="align-middle">{{ $item->grid }}</td>
                    <td class="align-middle text-right">
                        {{ Form::open(array(
                            'id' => 'deleteItem'.$item->id,
                            'method' => 'DELETE',
                            'route' => ['admin.dashboard.destroy', $item->id])) }}
                        {{ Form::close() }}

                        <div class="btn-group">
                            <a href="{{ route('admin.dashboard.edit',[$item->id]) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> @lang('global.app_edit')</a>
