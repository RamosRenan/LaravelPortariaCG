...
@section('content_header')
    <h1><i class="fa fa-list"></i> @lang('menu.add_menu_item')</h1>
@stop
...
@section('content')
{{ Form::open(['method' => 'POST', 'class' => 'formAjax', 'route' => ['admin.menuitem.store']]) }}
    {{ Form::hidden('menu_id', $menuId) }}
    <div class="row">
        <div class="col-md-4 form-group">
            {{ Form::label('parent_id', __('menu.fields.parent').'*', ['class' => 'control-label']) }}
            {{ Form::select('parent_id', $menuParent, old('parent_id'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) }}
        ...
        <div class="col-md-4 form-group">
            {{ Form::label('permission', __('menu.fields.permission'), ['class' => 'control-label']) }}
    ...
    <div class="row">
        ...
        <div class="col-md-4 form-group">
            {{ Form::label('route', __('menu.fields.route'), ['class' => 'control-label']) }}
    ...
    {{ Form::button('<i class="fa fa-plus"></i> ' .__('global.app_create'), ['type' => "submit", 'class' => 'btn btn-primary btn-sm float-right']) }}
{{ Form::close() }}
@stop
