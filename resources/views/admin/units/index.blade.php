...
<script>
    ...
    var route = '{{ route('admin.units.mass_destroy') }}';
</script>
@stop
...
@section('content')
    <div class="card card-default">
        <div class="card-header">
            <div class="row">
                <div class="col-md-6">
                    <a href="{{ route('admin.units.create') }}" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> @lang('global.app_create')</a>
                </div>
                <div class="col-md-6">
                    <div class="float-sm-right">
                        {{ Form::open(['method' => 'GET', 'route' => ['admin.units.index']]) }}
            ...
            <table class="table table-head-fixed table-hover">
                <thead>
                    <tr>
                        ...
                        <th>@lang('units.fields.name')</th>
                        <th>@lang('units.fields.code')</th>
                        <th>&nbsp;</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr data-entry-id="{{ $item->id }}">
                        ...
                        <td class="align-middle text-right">
                            {{ Form::open([
                                ...
                                'method' => 'DELETE',
                                'route' => ['admin.units.destroy', $item->id]
                            ]) }}
                            <div class="btn-group">
                                <a href="{{ route('admin.units.edit',[$item->id]) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> @lang('global.app_edit')</a>
