...
@section('content')
{{ Form::model($item, ['method' => 'PUT', 'route' => [$route, $item->id]]) }}
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {{ Form::text('username', old('login'), ['class' => 'form-control', 'placeholder' => __('users.fields.username'), 'required' => '', 'readonly' => '']) }}
...
@endphp
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {{ Form::select('roles[]', $roles, old('permission') ? old('permission') : $item->roles->pluck('name'), ['class' => 'form-control select2', 'multiple' => 'multiple']) }}
                        @if($errors->has('roles'))
