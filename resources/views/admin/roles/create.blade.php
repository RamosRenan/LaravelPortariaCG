    ...
    <div class="card card-default">
        ...
        <div class="card-body">
            ...
            <div class="tab-content" id="roles-mode-tabContent">
                ...
                {{ Form::open(['method' => 'POST', 'route' => [$routeURL]]) }}
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            ...
                            {{ Form::select('permission[]', $permissions, old('permission'), ['style' => 'width: 100%;', 'class' => 'form-control select2', 'multiple' => 'multiple']) }}
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <div class="card card-primary">
                                ...
                                @foreach ($controllers as $controller => $actions)
                                    ...
                                    <label class="ml-5">
                                        <div class="checkbox icheck-primary d-inline">
                                            {{ Form::checkbox('permission[' .$module. '][]', $action, in_array($action, []) ? true : false, ['class' => $module.$controller, 'id' => 'selectId'.$module.$controller.$name]) }}
